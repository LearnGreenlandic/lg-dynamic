...
S.patterns.append([
	...
	sfx(C() | Grep(r'(Sem/(Hfam|Hprof)(\+KU)?\+N\+Abs\+Pl\+1SgPoss\s)') | Inv(r'(angajoqqaaq|ilinniarnertooq|ilinniartoq|oqaasilerisoq|sakkutooq|tusagassiortoq|eqqumiitsuliortoq|aappaq|anaana|ataata|nuliaq|ui|marluliaq|kunngi)'), '\t@OBJ>'),
...
S.patterns.append([
	sfx(C() | Grep(r'Sem/(remember|think|assume|say|comprehend)\+V\+Ind\+1(Sg|Pl)\+3SgO'), '\t@PRED'),
	sfx(C() | Grep(r'((Mask|Fem)\+Prop\+Abs)'), '\t@OBJ>'),
	sfx(C() | Grep(r'Prop\+Lok\+(Sg|Pl)\s') | Inv(r'Sem/inst\+KKUT') | Inv(r'(Tusagassiornermik|Ilisimatusarfik).*Pl\s'), '\t@ADVL>'),
