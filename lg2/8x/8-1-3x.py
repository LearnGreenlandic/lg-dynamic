...
S.patterns.append([
	...
	sfx(C() | Grep(r'Sem/(require|socialize|teach|chase|encounter|serve)\+(SSA|NIAR\+Sem/plan)\+V\+Cau\+3Sg\+3SgO') | Inv(r'^asa'), '\t@CAU>'),
...
S.patterns.append([
	...
	['.\t.\t@CLB'],
	sfx(C() | Grep(r'Sem/(Fem|Mask).*Prop\+Rel\+Sg'), '\t@SUBJ>'),
	sfx(C() | Grep(r'Sem/(require|socialize|teach|chase|encounter|serve)(\+NIAR\+Sem/plan)?\+V\+Cau\+3Sg\+3PlO') | Inv(r'^asa'), '\t@CAU>'),
