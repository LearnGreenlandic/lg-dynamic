...
S.patterns.append([
	...
	sfx(C() | Grep(r'Sem/Geo\+Prop\+Trm\+Sg\+KAR\+(SSA|GUSUP\+Sem/wish|NIAR\+Sem/plan)\+V\+Ind\+1Sg'), '\t@PRED'),
	['.\t.\t@CLB'],
	])
S.patterns.append([
	...
	['.\t.\t@CLB'],
	sfx(C() | Grep(r'Sem/(require|socialize|teach|chase|encounter|serve)(\+NIAR\+Sem/plan)?\+V\+Cau\+1Sg\+3PlO') | Inv(r'^asa'), '\t@CAU>'),
	sfx(C() | Grep(r'(ippassaq|ullumi|aatsaat|massakkut)') | Inv(r'\+N'), '\t@ADVL>'),
	sfx(C() | Grep(r'Sem/inst\+Prop\+(Trm.*\+KAR|Lok.*IP)(\+(GUSUP\+Sem/wish|NIAR\+Sem/plan))?\+V\+Ind\+1Sg'), '\t@PRED'),
	['.\t.\t@CLB'],
	])
