...
S.patterns.append([
	...
	sfx(C() | Grep(r'^(ilinniartip|naapip).*TAQ\+SSAQ\+QAR\+Sem/have\+V\+Ind\+1Sg') | Inv(r'GIARTUR\+SINNAA\+NNGIT'), '\t@PRED'),
	['.\t.\t@CLB'],
	sfx(C() | Grep(r'(aappaagu|aasaru|aqagu|aqaguagu|ullumi)\+Adv'), '\t@CL-ADVL>'),
	['P1\tP1\t@ADVL>'],
	sfx(C() | Grep(r'^(ilinniartip|naapip).*GIARTUR\+SSA\+V\+Ind\+1Sg\+3'), '\tP2'),
	['.\t.\t@CLB'],
	])
S.patterns.append([
	sfx(C() | Grep(r'Sem/Hfam.*Abs\+Sg\+1SgPoss') | Inv(r'(TAR|NIQ|INNAQ|NNGIT|SSAQ)'), '\t@SUBJ>'),
	sfx(C() | Grep(r'Sem/(Geo|inst\+Sem/Hum).*\+Lok') | Inv(r'IP'), '\t@ADVL>'),
	sfx(C() | Grep(r'^(ilinniartip|naapip).*TAQ\+SSAQ\+QAR\+Sem/have\+V\+Ind\+3Sg') | Inv(r'GIARTUR\+SINNAA\+NNGIT'), '\t@PRED'),
	['.\t.\t@CLB'],
	sfx(C() | Grep(r'(aappaagu|aasaru|aqagu|aqaguagu|ullumi)\+Adv'), '\t@CL-ADVL>'),
	['P3\tP3\t@SUBJ>'],
	['P4\tP4\t@ADVL>'],
	sfx(C() | Grep(r'^(ilinniartip|naapip).*GIARTUR\+SSA\+V\+Ind\+3Sg\+3'), '\tP5'),
	['.\t.\t@CLB'],
	])
S.patterns.append([
